...
public class Laziness {
    ...
    public static void main(String[] args) {
        ...
        // you may have expected that all numbers 1 up to 8 will be evaluated in the filter and then mapped by squaring
        // them and that only then the first two square results (4 and 8) are put in the twoEvenSquares list.
        ...
        // Hence, the elements 5,6,7 and 8 are never processed, because after processing 1,2,3 and 4 we already had two
        // resulting elements.
        //
        // This laziness is extremely valuable with large datasets and difficult to realize with imperative iteration
        System.out.printf("The resulting first two even elements squared: %s\n", twoEvenSquares);
    }
